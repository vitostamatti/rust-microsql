...
// Define custom error
pub type ParseError<'a> = ErrorTree<RawSpan<'a>>;
...
pub fn format_parse_error<'a>(input: &'a str, e: ParseError<'a>) -> FormattedError<'a> {
    match e {
        // normal error like unexpected character
